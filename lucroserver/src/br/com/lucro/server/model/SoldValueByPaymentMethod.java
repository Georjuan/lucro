...
public class SoldValueByPaymentMethod {
	...
	public SoldValueByPaymentMethod() {
		super();
	}
	
	public SoldValueByPaymentMethod(Double debt, Double creditInCash, Double creditFinancied) {
		this.debt = debt;
